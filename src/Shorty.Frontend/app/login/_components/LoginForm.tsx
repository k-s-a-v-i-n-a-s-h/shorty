...
export default function ShortenForm() {
  ...
  useEffect(() => {
    if (state?.unverified) {
      setUnverified(state.unverified);
    }
  ...
  return (
    <form action={formAction} noValidate autoComplete="off" className="flex w-full flex-col gap-12">
      ...
      <p className="text-sm font-medium text-zinc-600 dark:text-zinc-400 animate-in fade-in slide-in-from-left-2">
        Can't find your verification email? Check your spam folder or {" "}
        <a
